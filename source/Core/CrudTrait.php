...
trait CrudTrait
{
    ...
    protected function create(array $data) : ?int
    {
        ...
        try{
            ...
            Log::error("crudTraitCreate", $exception->getMessage(), ["exception" => $exception]);
            $this->fail = $exception;
            return null;
        }
    }
    ...
    protected function update(array $data, string $terms, string $params) : ?int
    {
        ...
        try{
            ...
            Log::error("crudTraitUpdate", $exception->getMessage(), ["exception" => $exception]);
            $this->fail = $exception;
            return null;
        }
    }
    ...
    public function delete(string $terms, ?string $params) : bool
    {
        try{
            ...
            Log::error("crudTraitDelete", $exception->getMessage(), ["exception" => $exception]);
            $this->fail = $exception;
            return false;
        }
    }
